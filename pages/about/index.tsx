    ...
    <div className="pt-14">
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        ...
        >
          ...
          <p className="text-xl">
            Ne jemi një ekip pasionant që ndërtojmë aplikacione moderne dhe të
            fuqishme me teknologji të avancuar.
          </p>
        </motion.section>
...
>
  ...
  <p className="text-gray-700 mb-6">
    Misioni ynë është të ofrojmë zgjidhje inovative dhe të qëndrueshme për zhvillimin e aplikacioneve
    që përmbushin nevojat e klientëve tanë në mënyrë të plotë.
  </p>
</motion.section>
...
>
  <div className="container mx-auto">
    <h2 className="text-4xl font-bold mb-6 text-yellow-600">Vizioni Ynë</h2>
